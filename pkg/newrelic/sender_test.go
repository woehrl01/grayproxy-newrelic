...
func Test_convertToNewRelicFormat(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "test1", args: struct{data []byte}{data: []byte(`{"version":"1.1","host":"example.org","short_message":"A short message","full_message":"Backtrace here nnn","timestamp":1296000000.0,"level":5,"_some_info":"foo","_some_env_var":"bar"}`)}, wantOutput: []byte(`{"_some_env_var":"bar","_some_info":"foo","logtype":"NOTICE","message":"A short message Backtrace here nnn","timestamp":1296000000}`), wantErr: false},
	}
